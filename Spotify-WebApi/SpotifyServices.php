...
require 'Services/Albums.php';
require 'Services/Artists.php';
require 'Services/Browse.php';
require 'Services/Follow.php';
require 'Services/Library.php';
require 'Services/Personalization.php';
require 'Services/Player.php';
require 'Services/Playlists.php';
require 'Services/Search.php';
require 'Services/Tracks.php';
require 'Services/UsersProfile.php';
